...
"Movimiento a traves de la sección delimitada"

    "Verificación de límites y colisiones"
    if not inside(head) or head in snake:
        square(head.x, head.y, 9, 'red')    "Muestra un cuadrado rojo"
        update()
        return

    snake.append(head)      "Agrega la nueva posición de la cabeza a la serpiente"
    ...
    if head == food:
        ...
        snake.pop(0)    "Elimina la cola de la serpiente"
